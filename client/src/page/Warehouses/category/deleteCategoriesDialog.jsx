...
const DeleteCategoriesDialog = ({open,handleClose,categoriesIds}) => {
    console.log("check",categoriesIds)
    const handleDelete = async e =>{
        ...
        try {
            const res = await fetch(`${BASE_URL}/category`,{
                ...
                body: JSON.stringify({_id:categoriesIds})
            })
    ...
    return (
        ...
        <DialogBody className="p-4">
              <div>
                  <p>Bạn có chắc là muốn xóa danh mục không!</p>
              </div>
