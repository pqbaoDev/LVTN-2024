...
const PrintStockOut = ({stockOut}) => {
    ...
    return (
        <div className="print-stockIn w-11/12 ml-10">
            ...
            <table className="border-slate-400 border-t-2">
                <thead className="bg-blue-100">
                    <tr>
                        ...
                        <th className="border-0 border-r-2 border-solid border-slate-400 p-1">THƯƠNG HIỆU</th>
                ...
                <tbody>
                    {latestStockIn.products.map((item, index) => {
                        ...
                        return (
                            <tr key={index}>
                                ...
                                <td className="bg-white hover:bg-blue-500 border-2 border-solid border-slate-400 p-1">{item?.product?.category?.name}</td>
                                <td className="bg-white hover:bg-blue-500 border-2 border-solid border-slate-400 p-1">{item?.product?.manuFacture?.name}</td>
                    ...
                    <tr className="bg-white hover:bg-blue-500 border-2 border-solid border-slate-400 p-1">
                        <td className="text-center font-semibold" colSpan={6}>TỔNG CỘNG</td>
