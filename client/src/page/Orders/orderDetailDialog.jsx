...
const OrderDetailDialog = ({ open, handleClose, orderId, setRefetch}) => {
    ...
    const handleComfirm = async (event) => {
        ...
        // Chỉ gửi voucher nếu hợp lệ
        const orderUpdate = {
            ...formData,
            status: newStatus, // Cập nhật trạng thái đơn hàng mới
            voucher: formData.voucher && formData.voucher._id ? formData.voucher._id : null,
    ...
    return (
        <div>
            {open ? (
                <div
                    className="justify-center pt-20 items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none"
                    onClick={handleClose} // Đóng modal khi click ra ngoài
                >
                    <div
                        className="relative my-6 mx-auto max-w-5xl"
                    ...
                    >
                        <div className="border-2 border-slate-500 rounded-lg shadow-2xl relative flex flex-col w-full bg-white outline-none focus:outline-none">
                            ...
                            <form onSubmit={handleComfirm}>
                                <div className="no-print text-white justify-center heading rounded-t-lg bg-blue-400 gap-3 p-5">
                                            ...
                                            <table className="w-full text-sm text-center">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td className='border-2 border-l-0 border-slate-300 text-end italic'>{FormatPrice (formData.voucher.sale)} <sup className='underline'>đ</sup></td>
                                                    </tr>
                                                    <tr>
                                                        <td></td>
                                                        <td></td>
                                                    ...
                                                    {
                                                        formData.payment === 'Đã thanh toán' ? (
                                                            <tr>
                                                        <td></td>
                                                        <td></td>
                                                        <td></td>
                                                        <td className='border-2 border-r-0 border-slate-300 text-end'></td>
                                                        <td className='border-2 border-l-0 border-slate-300 text-end'>Đã thanh toán:</td>
                                                        <td className='border-2 border-l-0 border-slate-300 text-end'>{FormatPrice(formData.totalAmount)} <sup className='underline'>đ</sup></td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td></td>
                                                        <td className='border-2 border-r-0 border-slate-300 text-end'></td>
                                                        <td className='border-2 border-l-0 border-slate-300 text-end font-semibold'>Thành tiền:</td>
                                                        <td className='border-2 border-l-0 border-slate-300 text-end font-semibold text-[22px] text-red-500'>
                                                            {formData.payment === 'Đã thanh toán' ? '0' : FormatPrice(formData.totalAmount)} <sup className='underline'>đ</sup>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                ...
                                <div>
                                    <div className="m-5 grid grid-cols-3 gap-5 no-print">
                                        <button
                                            type="button"
